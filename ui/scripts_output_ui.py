...
################################################################################
## Form generated from reading UI file 'scripts_output.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.logs_view = QTreeView(Form)
        self.logs_view.setObjectName(u"logs_view")
        self.logs_view.setLineWidth(0)
        self.logs_view.setMidLineWidth(0)
        self.logs_view.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.logs_view.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.logs_view.setSizeAdjustPolicy(QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.logs_view.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.logs_view.setTabKeyNavigation(True)
        self.logs_view.setAlternatingRowColors(False)
        self.logs_view.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.logs_view.setTextElideMode(Qt.TextElideMode.ElideLeft)
        self.logs_view.setHeaderHidden(False)
        self.logs_view.header().setVisible(True)
        self.logs_view.header().setDefaultSectionSize(550)

        self.verticalLayout.addWidget(self.logs_view)
...
#if QT_CONFIG(shortcut)
        self.save_btn.setShortcut(QCoreApplication.translate("Form", u"Ctrl+Return", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
